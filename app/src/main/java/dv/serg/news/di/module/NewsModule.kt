...
class NewsModule(private val newsActivity: NewsActivity) {
    ...
    @PerActivity
    @Provides
    fun providePresenter(retrofit: Retrofit, sourceDao: Flowable<List<String>>, historyDao: Dao<History>, bookmarkDao: Dao<Bookmark>, filterList: MutableList<String>): NewsPresenter {
